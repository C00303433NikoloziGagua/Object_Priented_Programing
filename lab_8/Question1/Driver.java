...
public class Driver
{
  	...
  	{ 
		...
		circle.setRadius(10); // Set the radius for circle
		rectangle.setLength(10); // Set the length for rectangle
		rectangle.setWidth(5); // Set the width for rectangle
		sphere.setRadius(10); // Set the radius for sphere
		cylinder.setRadius(10); // Set the radius for cylinder
		cylinder.setHeight(10); // set the height for cylinder
